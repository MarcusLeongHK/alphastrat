...
import { addToWatchlist, type ActionResult } from "./actions";
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
        <div className="relative flex flex-col gap-1.5 sm:col-span-2">
          ...
          {showSuggestions && suggestions.length > 0 && (
            <div
              className="absolute z-10 mt-1 w-full rounded-lg border border-zinc-200 bg-white shadow-lg dark:border-zinc-700 dark:bg-zinc-900"
              style={{ top: "100%" }}
            >
