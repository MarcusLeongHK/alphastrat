...
<table>
  <tr>
    <td width="50%">
      ...
      <br><br>
      <img src="docs/images/overview-tab.png" alt="Overview tab">
    </td>
    <td width="50%">
      <strong>News</strong><br>
      AI-summarized news grouped into themes with source attribution (Groq + Llama 3).
      <br><br>
      <img src="docs/images/news-tab.png" alt="News tab">
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <br><br>
      <img src="docs/images/sentiment-tab.png" alt="Sentiment tab">
    </td>
    <td width="50%">
      ...
      <br><br>
      <img src="docs/images/thesis-tab.png" alt="Thesis tab">
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <br><br>
      <img src="docs/images/earnings-tab.png" alt="Earnings tab">
    </td>
    <td width="50%">
      ...
      <br><br>
      <img src="docs/images/options-ai.png" alt="Options AI analysis">
    </td>
  </tr>
</table>
...
![Options Charts](docs/images/options-charts.png)

### Earnings Calendar

Upcoming earnings across your watchlist, grouped by date with EPS/revenue estimates and ranges.

![Earnings Calendar](docs/images/earnings-calendar.png)
...
![Macro Dashboard](docs/images/macro.png)
